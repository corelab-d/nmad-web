  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center px-4">
      ...
      <div className="relative bg-white w-full max-w-md p-8 shadow-xl">
        <button onClick={onClose} className="absolute top-4 right-4 text-[#888] hover:text-[#1a1a1a] transition-colors text-lg leading-none">✕</button>
        ...
        {status === 'ok' ? (
          <div className="text-center py-8">
            ...
            <button onClick={onClose} className="text-[10px] tracking-widest uppercase text-[#888] hover:text-[#1a1a1a] transition-colors">
              Cerrar
            </button>
          </div>
        ) : (
